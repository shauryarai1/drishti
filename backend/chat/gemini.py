...
SYSTEM_INSTRUCTION = (
    ...
    "house position or dasha belonging to the person you are talking to - unless an "
    "authoritative calculated chart context block is supplied with this message. "
    "Birth details mentioned in the conversation are not permission to calculate: "
    "without that block, say the chart is needed rather than deriving a placement "
    "yourself.\n\n"
...
ASTROLOGY_INSTRUCTION = (
    ...
    "conversation using this context.\n\n"
